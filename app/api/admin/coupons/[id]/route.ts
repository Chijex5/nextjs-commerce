...
export async function PATCH(
  ...
  try {
    ...
    if (body.minOrderValue !== undefined) updateData.minOrderValue = body.minOrderValue || null;
    if (body.maxUses !== undefined) updateData.maxUses = body.maxUses || null;
    if (body.maxUsesPerUser !== undefined) updateData.maxUsesPerUser = body.maxUsesPerUser || null;
