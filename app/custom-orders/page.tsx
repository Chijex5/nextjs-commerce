            ...
            <div className="dp-rise-3 mt-10 grid gap-10 lg:grid-cols-2 lg:items-end">
              <div className="space-y-7 pb-4">
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <a href="#showcase" className="dp-btn-ghost">
                    See Past Work
                  </a>
                </div>
              </div>
        ...
        >
          <div className="grid gap-16 lg:grid-cols-2 lg:gap-24">
            ...
            <div>
              ...
              >
                Fill in your brief and we&apos;ll get back to you within 24
                hours with a design concept and quote.
              </p>
              ...
              >
                ...
                <div>
                  ...
                  <input
                    className="co-input"
                    type="text"
                    placeholder="e.g. Full-grain leather, Ankara, Suede…"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    className="co-input"
                    rows={5}
                    placeholder="Describe the colour, finish, occasion, any monogram or embellishment ideas…"
                  />
                </div>
                ...
                <div>
                  ...
                  <div
                    style={{
                      border: "1px dashed rgba(242,232,213,0.18)",
                      padding: "1.5rem",
                      textAlign: "center",
                      cursor: "pointer",
                    }}
                ...
                >
                  We usually respond within a few hours. No commitment required
                  yet.
                </p>
              </div>
            </div>
