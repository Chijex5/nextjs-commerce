...
import { Bebas_Neue, Cormorant_Garamond, DM_Sans, Inter } from "next/font/google";
...
export default async function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${inter.variable} ${bebasNeue.variable} ${cormorantGaramond.variable} ${dmSans.variable} dark`}
