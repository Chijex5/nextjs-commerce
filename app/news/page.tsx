...
export const metadata: Metadata = {
  title: "News & Updates",
  description: "Stay informed with the latest news, announcements, and updates from our office.",
  openGraph: {
    type: "website",
  },
};
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-12">
      ...
      <p className="mb-12 text-lg text-neutral-700 dark:text-neutral-300">
        Stay informed with the latest news, press releases, and announcements from our office.
      </p>
      ...
      <div className="space-y-8">
        {newsItems.map((item, index) => (
          ...
          >
            ...
            <p className="text-neutral-700 dark:text-neutral-300">{item.excerpt}</p>
      ...
      <div className="mt-12 text-center">
        <p className="text-neutral-600 dark:text-neutral-400">
          For media inquiries, please visit our <a href="/contact" className="font-medium underline">contact page</a>.
        </p>
      </div>
    </div>
  );
