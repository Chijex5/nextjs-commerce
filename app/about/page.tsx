...
export const metadata: Metadata = {
  title: "About",
  description: "Learn about our public office holder's background, education, and career journey.",
  openGraph: {
    type: "article",
  },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12">
      ...
      <section className="mb-12">
        ...
        <div className="prose prose-lg dark:prose-invert">
          ...
          <p className="mb-4 leading-relaxed text-neutral-700 dark:text-neutral-300">
            This section will contain a comprehensive biography of the public office holder, 
            including their background, early life, education, and path to public service.
          </p>
        </div>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-4">
          <div className="border-l-4 border-neutral-300 pl-4 dark:border-neutral-700">
            ...
            <p className="text-neutral-700 dark:text-neutral-300">[Institution]</p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          <div className="border-l-4 border-neutral-300 pl-4 dark:border-neutral-700">
            <p className="text-neutral-600 dark:text-neutral-400">[Year - Present]</p>
          ...
          <div className="border-l-4 border-neutral-300 pl-4 dark:border-neutral-700">
            <p className="text-neutral-600 dark:text-neutral-400">[Year - Year]</p>
      ...
      <section>
        ...
        <div className="prose prose-lg dark:prose-invert">
          <p className="leading-relaxed text-neutral-700 dark:text-neutral-300">
            [Placeholder for the politician's core values and vision for public service]
          </p>
        </div>
      </section>
    </div>
