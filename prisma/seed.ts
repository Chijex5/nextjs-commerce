      ...
      data: [
        {
          ...
          body: "<h2>Our Story</h2><p>D'FOOTPRINT is a handmade footwear brand specializing in slippers, slides, and other custom footwear. We combine traditional craftsmanship with modern design to create comfortable, stylish footwear.</p><h2>Our Mission</h2><p>We believe that every step matters. Our mission is to provide high-quality, handcrafted footwear that combines comfort, style, and durability. Each pair is made with love and attention to detail by skilled artisans.</p><h2>Why Choose Us</h2><ul><li>100% Handcrafted</li><li>Premium Materials</li><li>Comfortable Fit</li><li>Nationwide Delivery</li><li>Custom Orders Available</li></ul>",
